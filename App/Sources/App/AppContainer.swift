...
/// App-level DI container - provides Feature-level DI containers. Feature-level DI Containers provide necessary Layer dependencies (e.g. UseCases,
/// Repositories) within boundaries of some specific Feature.
